...
1. Edit the `secrets.py` file in the `deedown` directory. Use a text editor such as Notepad or [VS Code](https://code.visualstudio.com/). Place the values from your app in between the single quotes (`'...'`). If you cannot find your User ID, it is the 10-digit number at the end of your profile link on Deezer.
